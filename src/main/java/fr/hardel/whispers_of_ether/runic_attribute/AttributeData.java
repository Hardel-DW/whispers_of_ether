...
public record AttributeData(
    ...
    public record Range(double min, double max) {
        public static final Codec<Range> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.DOUBLE.fieldOf("max").forGetter(Range::max)).apply(instance, Range::new));
    }

    public static final Codec<AttributeData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        Identifier.CODEC.fieldOf("attribute").forGetter(AttributeData::attribute),
        ...
        Range.CODEC.fieldOf("on_pass").forGetter(AttributeData::onPass)).apply(instance, AttributeData::new));
}
