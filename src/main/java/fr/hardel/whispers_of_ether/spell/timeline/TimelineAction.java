...
public record TimelineAction(String id, List<SpellAction> actions, int duration, Optional<LootItemCondition> condition, Optional<Integer> waitTime) {
    ...
    public static final Codec<TimelineAction> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        LootItemCondition.DIRECT_CODEC.optionalFieldOf("condition").forGetter(TimelineAction::condition),
