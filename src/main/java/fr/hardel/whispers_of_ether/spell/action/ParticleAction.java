...
public record ParticleAction(Identifier particle, Optional<Position> offset, Optional<Position> delta, int count, double speed, boolean force) implements Action {
