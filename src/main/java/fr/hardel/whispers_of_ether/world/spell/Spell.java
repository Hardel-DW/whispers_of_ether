...
import fr.hardel.whispers_of_ether.server.spell.timeline.OrganizationTimeline;
import fr.hardel.whispers_of_ether.server.spell.timeline.TimelineAction;
...
public record Spell(Identifier icon, String name, Optional<Integer> cooldown,
    ...
    public boolean canCast(Player caster, Identifier spellId) {
        var spellComponent = EntityComponents.PLAYER_SPELL.get(caster);
