package fr.hardel.whispers_of_ether.world.object;
...
/**
 * Registry entry for scene object types. Empty payload; identity is the registry key. Server/common side definition only; client renderers are
 * registered separately.
 */
public final class SceneObjectType {
    public static final ResourceKey<Registry<SceneObjectType>> REGISTRY_KEY = ResourceKey
        .createRegistryKey(Identifier.fromNamespaceAndPath(WhispersOfEther.MOD_ID, "scene_object_type"));
    ...
    public static final Codec<SceneObjectType> CODEC = Identifier.CODEC.comapFlatMap(
        ...
        t -> {
            ...
            return id != null ? id : Identifier.fromNamespaceAndPath(WhispersOfEther.MOD_ID, "unknown");
        });
