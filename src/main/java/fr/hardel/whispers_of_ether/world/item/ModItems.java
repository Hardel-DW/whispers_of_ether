...
public class ModItems {
    ...
    public static void register() {
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.WHISPERSOFETHER_RUNES_GROUP_KEY).register(content -> {
            content.accept(RUNE);
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.WHISPERSOFETHER_GENERAL_GROUP_KEY).register(content -> {/*
