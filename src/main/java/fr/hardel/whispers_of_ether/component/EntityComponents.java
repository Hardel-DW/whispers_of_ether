...
public class ModComponents implements EntityComponentInitializer {
        ...
        public static final ComponentKey<WaypointComponent> WAYPOINTS = ComponentRegistry.getOrCreate(Identifier.fromNamespaceAndPath(WhispersOfEther.MOD_ID, "waypoints"), WaypointComponent.class);

        public static final ComponentKey<OmnivampirismComponent> OMNIVAMPIRISM = ComponentRegistry.getOrCreate(Identifier.fromNamespaceAndPath(WhispersOfEther.MOD_ID, "omnivampirism"), OmnivampirismComponent.class);
